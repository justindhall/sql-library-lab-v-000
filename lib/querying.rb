...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) AS total FROM character_books JOIN characters ON character_books.character_id = character_id GROUP BY characters.name ORDER BY total DESC"
end
